...
- `POST /api/menu/playlist/start-upload` — запустить немедленную синхронизацию плейлиста и видео (не управляет встроенным планировщиком, который запускается автоматически и работает постоянно)
...
- `POST /api/menu/video/start-upload` — запустить немедленную синхронизацию видео (не управляет встроенным планировщиком, который запускается автоматически и работает постоянно)
